          ...
          <div className="blog-post-header11-section-title thq-flex-column">
            <div className="blog-post-header11-breadcrumbs thq-flex-row">
              ...
              <span>
                {props.category ?? (
                  <Fragment>
                    <span className="blog-post-header11-text17 thq-body-small">
                      Category
                    </span>
                  </Fragment>
                )}
            ...
            <div className="blog-post-header11-content2">
              <h1>
                {props.blogPostTitle ?? (
                  <Fragment>
                    <h1 className="blog-post-header11-text16 thq-heading-1">
                      Latest Blog Posts
                    </h1>
                  </Fragment>
                )}
              ...
              <div className="blog-post-header11-time">
                <span>
                  {props.date ?? (
                    <Fragment>
                      <span className="blog-post-header11-text15 thq-body-small">
                        23 March 2024
                      </span>
                    </Fragment>
                  )}
                ...
                <span>
                  {props.readTime ?? (
                    <Fragment>
                      <span className="blog-post-header11-text18 thq-body-small">
                        5 min read
                      </span>
                    </Fragment>
                  )}
