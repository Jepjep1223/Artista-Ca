...
const Features181 = (props) => {
  return (
    <div className="features181-layout349 thq-section-padding">
      <div className="features181-max-width thq-section-max-width">
        <div className="features181-content1">
          <div className="features181-section-title1">
            <div className="features181-content2">
              <div className="features181-section-title2 thq-flex-column">
                <div className="features181-breadcrumbs thq-flex-row"></div>
                <div className="features181-content3">
                  <h1>
                    {props.blogPostTitle ?? (
                      <Fragment>
                        <h1 className="features181-text6 thq-heading-1">
                          Latest Blog Posts
                        </h1>
                      </Fragment>
                    )}
                  </h1>
                  <div className="features181-author">
                    <span>
                      {props.avatarName ?? (
                        <Fragment>
                  ...
                  <div className="features181-time">
                    <span>
                      {props.date ?? (
                        <Fragment>
                    ...
                    <span>
                      {props.readTime ?? (
                        <Fragment>
                          <span className="thq-body-small">5 min read</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
                ...
                <div className="thq-flex-row">
                  ...
                  <div className="features181-share-buttons">
        ...
        <div className="features181-image-container">
          <img
            ...
            className="thq-img-ratio-16-9 features181-placeholder-image"
          />
        </div>
      </div>
    </div>
