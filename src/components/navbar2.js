...
const Navbar2 = (props) => {
  return (
    <header id={props.navbar2Id} className="navbar2-container">
      <header data-thq="thq-navbar" className="navbar2-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar2-desktop-menu">
          <nav className="navbar2-links1">
            <a href={props.link1Url} className="navbar2-link11">
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar2-text2 thq-body-small thq-link">
                    Link1
                  </span>
                </Fragment>
              )}
            ...
            <a href={props.link2Url} className="navbar2-link21">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar2-text3 thq-body-small thq-link">
                    Link2
                  </span>
                </Fragment>
              )}
            ...
            <a href={props.link3Url} className="navbar2-link31">
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar2-text1 thq-body-small thq-link">
                    Link3
                  </span>
                </Fragment>
              )}
            ...
            <a href={props.link4Url} className="navbar2-link41">
              {props.link4 ?? (
                <Fragment>
                  <span className="navbar2-text5 thq-body-small thq-link">
                    Link4
                  </span>
                </Fragment>
              )}
            </a>
            <a href={props.link5Url} className="navbar2-link51">
              {props.link5 ?? (
                <Fragment>
                  <span className="navbar2-text4 thq-body-small thq-link">
                    Link5
                  </span>
                </Fragment>
              )}
