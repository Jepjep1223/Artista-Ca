          ...
          <div className="blog-post-header2-title thq-flex-column">
            <div className="blog-post-header2-content1">
              ...
              <span>
                {props.category ?? (
                  <Fragment>
                    <span className="blog-post-header2-text17 thq-body-small">
                      Category
                    </span>
                  </Fragment>
                )}
            ...
            <div className="blog-post-header2-content2">
              <h1>
                {props.blogPostTitle ?? (
                  <Fragment>
                    <h1 className="blog-post-header2-text20 thq-heading-1">
                      Latest Blog Posts
                    </h1>
                  </Fragment>
                )}
              ...
              <div className="blog-post-header2-content3">
                <div className="blog-post-header2-author">
                  ...
                  <span>
                    {props.avatarName ?? (
                      <Fragment>
                        <span className="blog-post-header2-text16 thq-body-small">
                          Full name
                        </span>
                      </Fragment>
                    )}
                ...
                <div className="blog-post-header2-time">
                  <span>
                    {props.date ?? (
                      <Fragment>
                        <span className="blog-post-header2-text18 thq-body-small">
                          23 March 2024
                        </span>
                      </Fragment>
                    )}
                  ...
                  <span>
                    {props.readTime ?? (
                      <Fragment>
                        <span className="blog-post-header2-text19 thq-body-small">
                          5 min read
                        </span>
                      </Fragment>
                    )}
