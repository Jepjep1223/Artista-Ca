...
const Features17 = (props) => {
  return (
    <div
      id={props.features17Id}
      className="features17-layout349 thq-section-padding"
    >
      <div className="features17-max-width thq-section-max-width">
        ...
        <div className="features17-section-title thq-flex-column">
          <div className="features17-breadcrumbs thq-flex-row"></div>
          <div className="features17-content">
            <h1>
              {props.blogPostTitle ?? (
                <Fragment>
                  <h1 className="features17-text7 thq-heading-1">
                    Latest Blog Posts
                  </h1>
                </Fragment>
              )}
            </h1>
            <div className="features17-author">
              <span>
                {props.avatarName ?? (
                  <Fragment>
            ...
            <div className="features17-time">
              <span>
                {props.date ?? (
                  <Fragment>
                    <span className="features17-text6 thq-body-small">
                      {' '}
                      2024
                    </span>
                  </Fragment>
              ...
              <span>
                {props.readTime ?? (
                  <Fragment>
                    <span className="features17-text4 thq-body-small">
                      5 min read
                    </span>
                  </Fragment>
                )}
          ...
          <div className="thq-flex-row">
            ...
            <div className="features17-share-buttons">
