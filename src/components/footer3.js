...
const Footer3 = (props) => {
  return (
    <footer
      id={props.footer3Id}
      className="footer3-footer4 thq-section-padding"
    >
        ...
        <div className="footer3-content">
          ...
          <div className="footer3-links">
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="footer3-text5 thq-body-small">
                    Default value
                  </span>
                </Fragment>
              )}
            ...
            >
              {props.link4 ?? (
                <Fragment>
                  <span className="footer3-text4 thq-body-small">
                    Default value
                  </span>
                </Fragment>
              )}
